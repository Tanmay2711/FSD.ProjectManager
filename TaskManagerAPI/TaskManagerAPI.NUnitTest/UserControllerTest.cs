...
namespace TaskManagerAPI.NUnitTest
{
    ...
    public class UserControllerTest
    {
        ...
        public async Task TestUsersPutUserApi(int userId, User user)
        {
            ...
            Assert.AreEqual(user.FirstName, lst.FirstName, "Tasks propertie should match with the request parameter after successful updates");
        }
        ...
        public async Task TestUsersPostUserApi(User user)
        {
            ...
            Assert.AreEqual(user.FirstName, lst.FirstName, "Tasks propertie should match with the request parameter after successful post");
            Assert.AreEqual((((ObjectResult)res.Result).Value as User).UserID, user.UserID, "TaskId should match after sucessfull post");
        }
